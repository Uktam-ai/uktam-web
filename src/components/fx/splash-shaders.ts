/**
 * GLSL for the fluid cursor. Lifted from Pavel Dobryakov's WebGL-Fluid-Simulation
 * (MIT) by way of React Bits, unchanged except where noted — the numerical
 * scheme is the point of it and is not ours to improve.
 */
