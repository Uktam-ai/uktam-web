...
import { reportRuntimeError } from "../lib/report-error";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Uktam.ai — Offline Indic Speech Translation" },
      {
        name: "description",
        content:
          "Fully offline, on-device speech-to-speech translation between Indic languages on Android.",
      },
      { name: "author", content: "Uktam.ai" },
